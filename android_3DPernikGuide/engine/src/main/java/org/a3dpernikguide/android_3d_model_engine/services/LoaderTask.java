...
public abstract class LoaderTask extends AsyncTask<Void, Integer, List<Object3DData>> {
	...
	protected void onPreExecute() {
		super.onPreExecute();
		this.dialog.setMessage("Зареждане...");
	...
	protected void onProgressUpdate(Integer... values) {
		...
		switch (values[0]) {
			case 0:
				this.dialog.setMessage("Анализиране на модел...");
				break;
			case 1:
				this.dialog.setMessage("Разпределяне на паметта...");
				break;
			case 2:
				this.dialog.setMessage("Зареждане на данните..");
				break;
			case 3:
				this.dialog.setMessage("Мащабиране на 3D модел...");
				break;
			case 4:
				this.dialog.setMessage("Изграждане на 3D модел...");
				break;
			case 5:
