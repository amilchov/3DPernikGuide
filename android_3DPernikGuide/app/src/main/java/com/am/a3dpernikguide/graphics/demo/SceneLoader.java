package com.am.a3dpernikguide.graphics.demo;
...
import com.am.a3dpernikguide.graphics.view.ModelRenderer;

import org.a3dpernikguide.android_3d_model_engine.animation.Animator;
import org.a3dpernikguide.android_3d_model_engine.collision.CollisionDetection;
import org.a3dpernikguide.android_3d_model_engine.model.Camera;
import org.a3dpernikguide.android_3d_model_engine.model.Object3DData;
import org.a3dpernikguide.android_3d_model_engine.services.LoaderTask;
import org.a3dpernikguide.android_3d_model_engine.services.Object3DBuilder;
import org.a3dpernikguide.android_3d_model_engine.services.wavefront.WavefrontLoaderTask;
import org.a3dpernikguide.util.android.ContentUtils;
import org.a3dpernikguide.util.io.IOUtils;
...
public class SceneLoader implements LoaderTask.Callback {
    ...
    public void onLoadComplete(List<Object3DData> datas) {
        ...
        makeToastText("Пресъздаден 3D модел!", Toast.LENGTH_LONG);
